...
public class JDialog_AddCompAcc extends JDialog
{
	...
	public JDialog_AddCompAcc(CardFrm parent)
	{
		...
		JButton_OK.setBounds(48,325,84,24);
		JButton_Cancel.setText("Cancel");
		JButton_Cancel.setActionCommand("Cancel");
		getContentPane().add(JButton_Cancel);
		JButton_Cancel.setBounds(156,325,84,24);
		...
		JLabelEmployeeNumber.setText("No. of Employees");
		getContentPane().add(JLabelEmployeeNumber);
		JLabelEmployeeNumber.setForeground(java.awt.Color.black);
		JLabelEmployeeNumber.setBounds(12,300,48,24);
		getContentPane().add(JTextField_EmployeeNumber);
		JTextField_EmployeeNumber.setBounds(84,300,156,20);
		//}}
	...
	javax.swing.JTextField JTextField_EmployeeNumber = new javax.swing.JTextField();
	javax.swing.JLabel JLabelEmployeeNumber = new javax.swing.JLabel();
	//}}
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		try{
			parentframe.NoEmployees = Integer.parseInt(JTextField_EmployeeNumber.getText());
		}
		catch(Exception e){
			parentframe.NoEmployees =1;
		}
